...
function saveOneIneraction(item) {
    ...
    if (isFinalSurvey == true || localStorage.getItem('isFinalSurvey') === "true") {
        ...
        newId = 'Mod_00_00_post_' + groupIdAndQuestionId;    // id should be Mod_00_00_Post_0
    }

    if (item.sections == 'survey') {
        result = 'correct';    // in survey question answer is always correct
        newId = 'Mod_0_0_Post_0';    // id should be Mod_0_0_Post_0
        objectives1Id = 'Post';    // initially it is 'survey' - has to be 'Post'
    }
