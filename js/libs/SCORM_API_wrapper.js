        ...
        if(API){
            ...
            if(success){
				...
				if(errorCode !== null && errorCode === 0){
					...
					trace(traceMsgPrefix +"successful.");
				} else {
	 		...
	 		if(scorm.handleExitMode && !exitStatus){
				...
				if(completionStatus !== "completed" && completionStatus !== "passed"){
					...
					switch(scorm.version){
						...
						case "2004": success = scorm.set("cmi.exit", "logout"); break;
					}
    ...
    if(scorm.connection.isActive){
        ...
        if(API){
            ...
            if(success){
                ...
                trace(traceMsgPrefix +"successful. value = " + value);
			} else {
...
pipwerks.SCORM.data.save = function(){
    ...
    if(scorm.connection.isActive){
        ...
        if(API){
			...
			if (success) {
                trace('SCORM.data.save successful');
            } else {
